...
функций придётся написать с нуля.
...
Это будет тем минимумом, который вам нужно будет реализовать.
...
В README дайте краткое описание режима, перечислите его возможности,
можете указать также, что режим не умеет. Затем дайте полное описание,
как пользоваться вашим режимом, как его настраивать.
Также неплохо описать, как режим работает, от каких других режимов или программ
...
После того, как пакет будет опубликован, MELPA будет следить за обновлениями его репозитория,
